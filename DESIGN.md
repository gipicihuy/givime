...
## Motion
≤150ms hover; rail scroll native; poster scale 1.03 (tanpa glow/shadow); hero **autoplay ~5s** crossfade + body rise (pause hover/focus/offscreen/`prefers-reduced-motion`).
