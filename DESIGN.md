...
## Components
- `FeaturedHero` = home hero cinematic multi-slide (backdrop + gradient + chevron/dots carousel + CTA)
...
## Motion
≤150ms hover; rail scroll native; poster scale 1.03 (tanpa glow/shadow); hero static tanpa autoplay (manual chevron/dots saja).
